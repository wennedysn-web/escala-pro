    ...
    <div className="bg-slate-900 rounded-3xl border border-slate-800 p-8">
      ...
      <div className="print-area bg-white text-black p-0 sm:p-10 shadow-2xl rounded-sm print:shadow-none print:p-0 overflow-x-auto">
        ...
        <div className="text-center border-b-2 border-black pb-2 mb-3">
          ...
          <p className="text-[8px] font-bold mt-0.5 uppercase text-black">EscalaPro V0.1.1 &bull; Relatório emitido em {new Date().toLocaleDateString('pt-BR')} às {new Date().toLocaleTimeString('pt-BR')}</p>
        </div>
